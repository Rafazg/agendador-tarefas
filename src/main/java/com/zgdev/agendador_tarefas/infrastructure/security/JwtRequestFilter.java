...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.zgdev.agendador_tarefas.infrastructure.security.JwtUtil jwtUtil;
    private final UserDetailsServiceImpl userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.zgdev.agendador_tarefas.infrastructure.security.JwtUtil jwtUtil, UserDetailsServiceImpl userDetailsService) {
